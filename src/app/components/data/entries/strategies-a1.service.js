class StrategiesA1Service {
    ...
    createStrategiesEntries(Builder) {
        ...
        entries.push(new Builder().id('0c92d9c4-c565-4ffc-94b0-9594014aabb3').thema(thema).entry('Na gut.').get());
        ...
        entries.push(new Builder().id('d32a005a-3ffa-4518-a12e-a501e8fe1a65').thema(thema).entry('Ach.').get());
        entries.push(new Builder().id('52e1b278-d620-4ce4-918a-66e794876267').thema(thema).entry('Sicher.').get());
        entries.push(new Builder().id('9db2a9bd-7c99-471c-9940-7813a8b61a2e').thema(thema).entry('Aha.').get());
        entries.push(new Builder().id('22698b2a-c9a4-4359-a371-5a0f9115bd86').thema(thema).entry('Naja.').get());
    ...
    createStrategiesWordEntries(Builder) {
        ...
        entries.push(new Builder().id('9bf0bf7e-6fcc-4b4c-a4fd-07f55edc06bc').thema(thema).entry('um das Wort bitten').get());
        entries.push(new Builder().id('b89ec4a5-b217-4fe8-b0af-1166e658c376').thema(thema).entry('Zuhören signalisieren').get());
        entries.push(new Builder().id('118f96aa-6b89-49cc-982d-bcc704b74e11').thema(thema).entry('zum Sprechen auffordern').get());
        entries.push(new Builder().id('018b7a0d-86b1-4c6d-8bcb-92e25e9014c4').thema(thema).entry('gemeinsames Wissen andeuten').get());
        entries.push(new Builder().id('e97b75e8-b08d-4645-8bb3-4b1c006d47b6').thema(thema).entry('Beispiele geben').get());
        entries.push(new Builder().id('97ebb94d-0707-46bc-ba5d-0fde25d6160c').thema(thema).entry('etwas verdeutlichen').get());
        entries.push(new Builder().id('b4da55ab-038a-453b-b133-e9947b84e771').thema(thema).entry('das Thema wechseln').get());
        entries.push(new Builder().id('127a37fe-2f3b-4e1d-b481-8d41877ce4ae').thema(thema).entry('etwas hervorheben').get());
        entries.push(new Builder().id('2122e01a-5ac3-462e-a70d-7eef629aa4fa').thema(thema).entry('Vermeidung').get());
        entries.push(new Builder().id('5b7c85ff-56f4-46e9-a2c9-a529ce932f4b').thema(thema).entry('Höflichkeit').get());
        entries.push(new Builder().id('a63a7904-3838-4787-acd4-4d3a40c94c04').thema(thema).entry('Abschwächung').get());
        ...
        entries.push(new Builder().id('02bc5249-8e0d-45d2-8a7e-fdaff054950b').thema(thema).entry('Selbstkorrektur').get());
