class VocabularyA1Service {
    ...
    createAEntries(Builder) {
		...
		entries.push(new Builder().id('43418e6a-42d2-4892-80f0-b66e79c505a0').thema(thema).entry('also').example(['Also, es ist so: ...', 'Er hat Zeit, also muss er uns helfen.']).get());
		...
		entries.push(new Builder().id('3687c156-36c7-49cd-ba3a-caf130b41712').thema(thema).entry('an').example(['Fahren Sie an der nächsten Straße nach rechts.', 'Wir treffen uns am Bahnhof.', 'Am nächsten Montag geht es leider nicht.']).get());
		entries.push(new Builder().id('1896fe7a-0f8e-485b-8b69-5eabff2f6ce0').thema(thema).entry('anbieten').example('Was darf ich dir anbieten?').get());
		entries.push(new Builder().id('b88be1b0-4a7f-419f-b8de-dc012480d9b5').thema(thema).entry('das Angebot, -e').example('Heute sind Sportschuhe im Angebot.').get());
		...
		entries.push(new Builder().id('3d5fda61-8818-4de5-91ec-c5a032c8e1f1').thema(thema).entry('anklicken').example('Da musst du dieses Wort anklicken.').get());
		entries.push(new Builder().id('dc8539ff-3ae3-42ea-a86b-d8944315532e').thema(thema).entry('ankommen').example('Wann kommt dieser Zug in Hamburg an?').get());
		entries.push(new Builder().id('d11a8479-6041-4f95-b3a9-0771aa279236').thema(thema).entry('die Ankunft').example('Auf diesem Plan steht nur die Ankunft(-szeit) der Züge.').get());
		entries.push(new Builder().id('928d91fc-b7da-4385-83c9-e5d8497cefc9').thema(thema).entry('ankreuzen').example('Auf dem Formular müssen Sie an mehreren Stellen etwas ankreuzen.').get());
		entries.push(new Builder().id('673a9d78-9f7d-4f74-b23b-b472ec0b929d').thema(thema).entry('anmachen').example('Mach bitte das Licht an!').get());
		entries.push(new Builder().id('6a4d80fc-9640-49b0-b98d-e9b5f796ac53').thema(thema).entry('(sich) anmelden').example('Wo kann ich mich anmelden?').get());
		entries.push(new Builder().id('03192112-fcc0-46b3-ba8d-5189f57b6cbd').thema(thema).entry('die Anmeldung').example('Eine Anmeldung für diesen Kurs ist nicht mehr möglich.').get());
		entries.push(new Builder().id('1df9099c-4285-45ce-bf0f-e1b6320bc704').thema(thema).entry('die Anrede').example('Schreiben Sie auch eine Anrede und einen Gruß.').get());
		...
		entries.push(new Builder().id('6b0cc80e-a660-416e-b4c1-1fc45034ee98').thema(thema).entry('die Ansage, -n').example('Hören Sie die Ansagen.').get());
		entries.push(new Builder().id('19a89f2c-be44-4210-b3db-0bb078bdf196').thema(thema).entry('der Anschluss').example(['In Mannheim haben Sie Anschluss nach Saarbrücken.', 'Ist das die Anmeldung für einen Telefonanschluss?']).get());
		entries.push(new Builder().id('f5098a31-0b81-4d09-9cf2-3d4763a5b21e').thema(thema).entry('an sein').example('Heute Nacht war das Licht an.').get());
		...
		entries.push(new Builder().id('406207cf-0e3a-4e85-900f-239b51881080').thema(thema).entry('die Anzeige, -n').example('Ich habe Ihre Anzeige in der Zeitung gelesen.').get());
		entries.push(new Builder().id('805b6745-f06a-46f9-b66d-79fee5f3e0a5').thema(thema).entry('(sich) anziehen').example('Ich muss mich noch anziehen.').get());
		...
		entries.push(new Builder().id('426ff939-6643-4bb9-a336-de2c849ec502').thema(thema).entry('auf').example(['Die Kinder spielen auf der Straße.', 'Auf Wiedersehen.', 'Wie heißt das auf Deutsch?']).get());
		...
		entries.push(new Builder().id('d3f921d7-f475-4663-a088-01c5b4378e41').thema(thema).entry('aufhören').example(['Der Kurs hört in einer Woche auf.', 'Hier hört die Bahnhofstraße auf.']).get());
		...
		entries.push(new Builder().id('12bebaf3-9e95-4a57-a969-531d260155aa').thema(thema).entry('aufstehen').example(['Ich muss immer um vier Uhr aufstehen.', 'Soll ich aufstehen?']).get());
		entries.push(new Builder().id('5f06d863-85c1-4f9a-a15c-c501ad51c4c6').thema(thema).entry('der Aufzug, -ü, e').example('In diesem Haus gibt es keinen Aufzug.').get());
		...
		entries.push(new Builder().id('2628fdb7-6b46-4f19-ab14-1f386b26e898').thema(thema).entry('aus').example('Er kommt aus Brasilien.').get());
		entries.push(new Builder().id('fec683a9-86be-40e7-9686-1e7fc2f20cf2').thema(thema).entry('der Ausflug').example('Morgen machen wir einen Ausflug nach Heidelberg.').get());
		entries.push(new Builder().id('1f37e3d9-35ab-49fb-be71-663a0a679aac').thema(thema).entry('ausfüllen').example('Füllen Sie bitte dieses Formular aus.').get());
		entries.push(new Builder().id('2d099649-4732-42ca-b9ee-d3fc670c6fbe').thema(thema).entry('der Ausgang').example('Wo ist der Ausgang?').get());
		entries.push(new Builder().id('ad1ae53e-1bf2-4605-9b8c-568deed5b03e').thema(thema).entry('die Auskunft, -ü, e').example('Können Sie mir eine Auskunft geben?').get());
		entries.push(new Builder().id('962ba1fd-36ed-478e-abf9-58afea919468').thema(thema).entry('das Ausland').example('Fahren Sie ins Ausland?').get());
		...
		entries.push(new Builder().id('f725003a-f5ec-4131-a762-671a57341efa').thema(thema).entry('ausmachen').example('Mach bitte das Licht aus!').get());
		entries.push(new Builder().id('4c1ce995-f950-4696-b316-9dc681f0872a').thema(thema).entry('die Aussage, -n').example('Ist die Aussage richtig oder falsch?').get());
		entries.push(new Builder().id('840249b5-8104-411d-92aa-9aa08343f6f4').thema(thema).entry('aussehen').example('Das sieht schön aus.').get());
		entries.push(new Builder().id('93d68d0c-c075-46d6-a5fb-47c064656708').thema(thema).entry('aus sein').example(['Das Licht ist aus.', 'Die Schule ist aus.']).get());
		entries.push(new Builder().id('27feacfc-5994-4da5-b5a1-85969d2adb22').thema(thema).entry('aussteigen').example('Wo muss ich aussteigen?').get());
		entries.push(new Builder().id('9f5117e9-5304-46df-bc67-05ccc414777a').thema(thema).entry('der Ausweis').example('Hier ist mein Ausweis.').get());
		entries.push(new Builder().id('4b6b8b9e-e38e-465d-80ce-a85a1d70b081').thema(thema).entry('(sich) ausziehen').example('Zieh die Schuhe aus, bitte!').get());
		...
		entries.push(new Builder().id('2eb7ba3d-7ada-450f-96ad-111b2593cd45').thema(thema).entry('der Automat').example('Die Fahrkarten gibt es nur am Automaten.').get());
    ...
    createBEntries(Builder) {
		...
		entries.push(new Builder().id('8505d973-b17d-4cf3-a390-283d5e674744').thema(thema).entry('das Bad').example('Wir haben kein großes Bad.').get());
		entries.push(new Builder().id('9a27f199-c902-4e06-85ec-a090a932d857').thema(thema).entry('baden').example('Ich bade nicht so gern, ich dusche lieber.').get());
		entries.push(new Builder().id('b3c416f2-e23a-4f4d-b6c8-42075949805a').thema(thema).entry('die Bahn').example(['Wir fahren lieber mit der Bahn.', 'Ich nehme die nächste Bahn.']).get());
		...
		entries.push(new Builder().id('fbdefecc-47ab-4b4f-8a8a-5af0035ae10d').thema(thema).entry('der Bahnsteig').example('Auf welchem Bahnsteig fährt der Zug?').get());
		entries.push(new Builder().id('d0681916-02a1-4f60-8619-619a330fff84').thema(thema).entry('bald').example('Ich komme bald.').get());
		...
		entries.push(new Builder().id('51aea63a-819d-4e3f-83a2-b1f9ada6c5cb').thema(thema).entry('die Bank').example(['Die Bank schließt schon um vier Uhr.', 'Er sitzt im Park auf einer Bank und liest.']).get());
		entries.push(new Builder().id('a86a7140-e120-45b8-aa8d-a64633f52383').thema(thema).entry('bar').example('Muss ich bar zahlen oder geht‘s auch mit Karte?').get());
		entries.push(new Builder().id('3b033db8-bfcb-4193-ad96-254eba42b725').thema(thema).entry('der Bauch').example('Seit gestern tut mir der Bauch weh.').get());
		...
		entries.push(new Builder().id('d5211377-dcdd-486d-a01e-9686512e0e1e').thema(thema).entry('der Beamte, -n').example('Fragen Sie die Beamtin an Schalter acht!').get());
		...
		entries.push(new Builder().id('7884918a-fa8a-4c4d-b735-cc7f533dc59c').thema(thema).entry('bei').example(['Offenbach liegt bei Frankfurt.', 'Ich wohne bei meinen Eltern.', 'Bei uns regnet es heute.', 'Er arbeitet bei der Polizei.']).get());
		...
		entries.push(new Builder().id('ce78184d-8db2-46b0-9aeb-3c33d9739a9d').thema(thema).entry('das Bein, -e').example('Mein rechtes Bein tut weh.').get());
		...
		entries.push(new Builder().id('57530167-5623-44c4-b366-a8ee4809929c').thema(thema).entry('der/die Bekannte, -n').example('Ein Bekannter von mir heißt Klaus.').get());
		...
		entries.push(new Builder().id('c402149b-d198-46a7-afb7-422a07510f62').thema(thema).entry('besichtigen').example('Ich möchte gern den Dom besichtigen.').get());
		...
		entries.push(new Builder().id('c898f6a7-e8ec-431a-b8bd-789925e435f8').thema(thema).entry('besuchen').example('Darf ich dich besuchen?').get());
		...
		entries.push(new Builder().id('b8011704-81f3-4322-93bf-bb69935c2207').thema(thema).entry('bezahlen').example('Wo muss ich bezahlen?').get());
		...
		entries.push(new Builder().id('67c33bc7-e5c4-4eb3-be77-d4eb3d1424c6').thema(thema).entry('das Bild, -er').example('Hast du ein Bild von deinem Sohn?').get());
		...
		entries.push(new Builder().id('71d0e49e-ad27-4f11-bbc6-b655c72941b0').thema(thema).entry('die Birne, -n').example('Ein Kilo Birnen, bitte!').get());
		entries.push(new Builder().id('72168994-7f13-4128-a6b0-f76f416ab1ca').thema(thema).entry('bis').example(['Ich fahre nur bis Stuttgart.', 'Ich warte bis morgen.']).get());
		entries.push(new Builder().id('090265ea-d714-49e6-b973-3c5556c3b52b').thema(thema).entry('bisschen').example('Ich spreche Englisch, Französisch und ein bisschen Deutsch.').get());
		...
		entries.push(new Builder().id('688af42a-e519-49af-8ada-0867615b0d5c').thema(thema).entry('die Bitte, -n').example('Ich habe noch eine Bitte.').get());
		entries.push(new Builder().id('ce65ddaa-27ea-4513-9b99-07f017d012d0').thema(thema).entry('bitten').example('Darf ich Sie um etwas bitten?').get());
		entries.push(new Builder().id('43151efa-20bb-4f5a-b5e0-1a4d4f95e52e').thema(thema).entry('bitter').example('Der Kaffee schmeckt bitter.').get());
		...
		entries.push(new Builder().id('0b106f1e-3553-4fd8-862f-2c6a3191bc76').thema(thema).entry('der Bleistift, -e').example('Hast du einen Bleistift?').get());
		entries.push(new Builder().id('b611a022-39b0-47fe-b320-adc293f76a44').thema(thema).entry('der Blick').example('Von diesem Hotel hat man einen guten Blick auf den Rhein.').get());
		entries.push(new Builder().id('ed54d09f-cc92-45bb-a7e9-37a965ad8ade').thema(thema).entry('die Blume, -n').example('Gefallen dir die Blumen?').get());
		entries.push(new Builder().id('d13f588f-9222-4d26-ad02-ec7623da0be5').thema(thema).entry('der Bogen').example('Schreiben Sie Ihre Lösungen bitte auf den Antwortbogen.').get());
		entries.push(new Builder().id('471aafe6-f3dd-4512-acf0-979928f122f5').thema(thema).entry('böse').example('Sie ist böse auf mich.').get());
		...
		entries.push(new Builder().id('13c1e545-7904-4c86-b320-8b70a68f707a').thema(thema).entry('breit').example('Wie breit ist der Schrank?').get());
		...
		entries.push(new Builder().id('87034ea8-5c69-4a26-9af5-ddac066de4ff').thema(thema).entry('der Buchstabe, -n').example('Diesen Buchstaben gibt es in meiner Sprache nicht.').get());
    ...
    createCEntries(Builder) {
		...
		entries.push(new Builder().id('49c0c572-fc64-4022-a196-571093216d79').thema(thema).entry('das Café, -s').example('Sollen wir uns im Café treffen?').get());
    ...
    createDEntries(Builder) {
		...
		entries.push(new Builder().id('83668d46-dae5-4325-993c-7004250dfbd3').thema(thema).entry('da').example(['Da hinten ist er ja.', 'Wir sprechen gerade über Paul. Da kommt er ja gerade.', 'Ich nehme das da.', 'Ist Herr Klein schon da?']).get());
		...
		entries.push(new Builder().id('3c4e2255-e2b9-4369-a43f-c0514e4a0d62').thema(thema).entry('daneben').example('Du kennst doch die Post. Daneben ist die Bank.').get());
		...
		entries.push(new Builder().id('00508aab-9ad9-4760-a256-94e1920ae40e').thema(thema).entry('dann').example('Ich muss noch schnell zur Post, dann komme ich.').get());
		...
		entries.push(new Builder().id('cd63f15d-f24f-46ff-804f-97804bd09a66').thema(thema).entry('denn').example('Ich kann nicht kommen, denn ich bin krank.').get());
		...
		entries.push(new Builder().id('90a1db4f-00f9-4c30-ae34-956bf148db2c').thema(thema).entry('das Doppelzimmer').example('Wollen Sie ein Doppelzimmer oder ein Einzelzimmer?').get());
		entries.push(new Builder().id('06d2c2fb-dc05-40fb-bfb7-6f2d6edeed08').thema(thema).entry('das Dorf, -ö, er').example('Meine Familie lebt in einem Dorf.').get());
		entries.push(new Builder().id('41c9f763-6221-4bd2-8fd3-27036e0371ef').thema(thema).entry('dort, -her, -hin').example(['Deine Tasche kannst du dorthin stellen.', 'Dort ist unser Haus.']).get());
		entries.push(new Builder().id('e07499e8-f3f8-4f02-9aae-c7163a010ea4').thema(thema).entry('draußen').example('Wollen wir draußen sitzen?').get());
		entries.push(new Builder().id('bb8296b0-9489-4636-a4ed-3abe70ece163').thema(thema).entry('drucken').example('Bitte drucke das Formular für mich.').get());
		...
		entries.push(new Builder().id('9648bcb4-1a6b-40e4-88f6-b2caf756bff0').thema(thema).entry('drücken').example('Drück hier, dann geht der Computer an.').get());
		entries.push(new Builder().id('e3fb53d1-3622-4e7f-94f0-89bfdea596e4').thema(thema).entry('durch').example('Am besten gehen Sie durch die Breite Straße.').get());
		entries.push(new Builder().id('b3c9d3d7-76cf-4428-8971-950460f7e3a5').thema(thema).entry('die Durchsage, -n').example('Ich habe die Durchsage nicht verstanden.').get());
		entries.push(new Builder().id('8b4fe139-bada-49a3-9b78-491f526ea3a5').thema(thema).entry('dürfen').example(['Sie dürfen hier nicht rauchen.', 'Darf ich Sie zu einem Kaffee einladen?', 'Es darf nicht mehr als 15 Euro kosten.']).get());
    ...
    createEEntries(Builder) {
		...
		entries.push(new Builder().id('4a00c5e4-aa5e-4ff5-bb73-c2eda869ac7f').thema(thema).entry('die Ecke, -n').example('An der nächsten Ecke links.').get());
		entries.push(new Builder().id('d4d376f9-0a64-4a80-99b1-9e5608d283fe').thema(thema).entry('die Ehefrau, -en/der Ehemann, ä, er').example('Das ist mein (Ehe-) Mann/meine (Ehe-) Frau.').get());
		...
		entries.push(new Builder().id('463410d8-c3f6-44c9-9c66-ee96e0484c73').thema(thema).entry('eilig').example('Hast du es eilig?').get());
		...
		entries.push(new Builder().id('cfd4e4b8-673d-4511-9967-054de6afade0').thema(thema).entry('einkaufen').example('Ich muss noch für morgen einkaufen.').get());
		entries.push(new Builder().id('4f1b3e08-04ba-4a2c-ad08-a2e147d076b9').thema(thema).entry('einladen').example('Darf ich Sie zu einem Kaffee einladen?').get());
		...
		entries.push(new Builder().id('9e537705-6aca-407c-8009-f01507c68b74').thema(thema).entry('einsteigen').example('Schnell, steig ein, der Zug fährt gleich.').get());
		entries.push(new Builder().id('215d2769-7041-412c-9ff9-b1c2264bc611').thema(thema).entry('der Eintritt').example('Der Preis für den Eintritt ist 5 Euro.').get());
		entries.push(new Builder().id('23a14180-9fa1-4c60-b0b2-1f3c2d663e1e').thema(thema).entry('das Einzelzimmer').example('Haben Sie noch ein Einzelzimmer?').get());
		...
		entries.push(new Builder().id('6ec10241-fb15-41a1-9594-29232abf5c34').thema(thema).entry('der Empfänger, –').example('Auf dem Brief steht dein Name, also bist du der Empfänger.').get());
		entries.push(new Builder().id('7486947f-344d-428d-97e9-e484939eae72').thema(thema).entry('empfehlen').example('Welchen Wein können Sie mir empfehlen?').get());
		...
		entries.push(new Builder().id('46c3864e-d88f-4a1f-8f03-225f63643877').thema(thema).entry('entschuldigen').example('Entschuldigen Sie bitte!').get());
		entries.push(new Builder().id('3e59344d-0432-4e1c-adbe-146958431d2d').thema(thema).entry('die Entschuldigung').example('Entschuldigung! – Bitte.').get());
		entries.push(new Builder().id('20c1900b-cc3a-4481-b041-14c92c880bd6').thema(thema).entry('er').example('Er heißt Ali.').get());
		entries.push(new Builder().id('d07f1139-f212-49b5-9358-9eee5184b9ba').thema(thema).entry('das Ergebnis, -se').example('Das Ergebnis des Tests bekommen Sie in zwei Wochen.').get());
		...
		entries.push(new Builder().id('247b7488-f31c-413d-944c-bae745f7f4ba').thema(thema).entry('erlauben').example('Rauchen ist hier nicht erlaubt.').get());
		...
		entries.push(new Builder().id('60964919-aabb-4372-929f-9d54a897fd30').thema(thema).entry('das Essen').example('Das Essen ist heute sehr gut.').get());
		entries.push(new Builder().id('90cc4fb5-5276-493b-97a3-99bb8f64707b').thema(thema).entry('euer').example('Euer Kurs beginnt heute.').get());
        return entries;
    }
    ...
    createFEntries(Builder) {
		...
		entries.push(new Builder().id('ea45ec2b-6fac-4dcd-966f-83f052cc9714').thema(thema).entry('die Fahrkarte, -n').example('Hast du schon eine Fahrkarte?').get());
		...
		entries.push(new Builder().id('7e17939b-e80c-42c6-847d-698cde169c88').thema(thema).entry('der Familienstand').example('Bei „Familienstand“ musst du „ledig“ ankreuzen.').get());
		...
		entries.push(new Builder().id('c63b11ac-7cc9-4e68-a69c-b87b2b8c9c55').thema(thema).entry('Feier-').example(['z. B. Feierabend, Feiertag', 'Am Montag ist Feiertag.']).get());
		...
		entries.push(new Builder().id('4cc06604-799d-4744-b2d5-e12a09ad7323').thema(thema).entry('fehlen').example(['Herr Müller ist nicht da, er fehlt schon seit drei Tagen.', 'Was fehlt Ihnen?']).get());
		...
		entries.push(new Builder().id('92d830df-3b9c-43ef-b891-debe41925ac6').thema(thema).entry('finden').example('Wir müssen den Schlüssel finden.').get());
		...
		entries.push(new Builder().id('576a05e1-110b-487e-b45f-9a86b2e2ae07').thema(thema).entry('fliegen').example('Ich fliege nicht gern. Deshalb fahre ich mit dem Zug.').get());
		entries.push(new Builder().id('3800b932-260a-4416-8f1c-48c023e36f9e').thema(thema).entry('abfliegen').example('Wann fliegst du ab?').get());
		entries.push(new Builder().id('2924dddd-4fe2-4d2e-80fe-7e9e8c8e8637').thema(thema).entry('der Abflug').example('Der Abflug ist um 11.20 Uhr.').get());
		...
		entries.push(new Builder().id('55827877-7340-4a28-9a59-35d71853683d').thema(thema).entry('fremd').example('Das weiß ich nicht; ich bin fremd hier.').get());
		...
		entries.push(new Builder().id('0a35c425-f05d-477e-a41d-4e011a285835').thema(thema).entry('die Führung').example('Die Führung durch das Haus beginnt in 3 Minuten.').get());
    ...
    createGEntries(Builder) {
		...
		entries.push(new Builder().id('a607b7d8-49b9-4d4e-a4b3-d644a3bcde11').thema(thema).entry('der Gast, -ä, e').example('Am Wochenende haben wir mehrere Gäste.').get());
		entries.push(new Builder().id('cbb996a6-b857-4c67-ad8e-0c96e6560fcf').thema(thema).entry('geben').example(['Kannst du mir bitte deinen Kugelschreiber geben?', 'Es gibt keine Karten mehr.']).get());
		entries.push(new Builder().id('9e001e93-ac03-4a23-84cd-48781560363a').thema(thema).entry('geboren').example('Ich bin in Zagreb geboren.').get());
		entries.push(new Builder().id('49d74ef6-155a-4d5b-bee6-31b77e7bab5a').thema(thema).entry('das Geburtsjahr').example('Das Geburtsjahr Ihres Sohnes, bitte?').get());
		entries.push(new Builder().id('89404b94-7386-46a9-9d77-b51c262f882a').thema(thema).entry('der Geburtsort').example('Bitte schreiben Sie Ihren Geburtsort auf das Formular.').get());
		...
		entries.push(new Builder().id('9212f2b6-cc03-493c-bc50-ff6c6be16d29').thema(thema).entry('gefallen').example('Das gefällt mir.').get());
		...
		entries.push(new Builder().id('4ed3eb29-9e25-426d-9e2b-c507e873bb40').thema(thema).entry('gehören').example('Wem gehört das?').get());
		...
		entries.push(new Builder().id('07fbc94d-ce00-403d-af3f-3a41bfdfb647').thema(thema).entry('das Gepäck').example('Wollen Sie Ihr Gepäck mitnehmen?').get());
		entries.push(new Builder().id('cf048668-80c2-475a-b205-b6a353a8aa1e').thema(thema).entry('gerade').example('Da kommt er ja gerade.').get());
		entries.push(new Builder().id('f3be5f5f-d2b7-4782-bd4e-cfae35d78f62').thema(thema).entry('geradeaus').example('Gehen Sie immer geradeaus!').get());
		entries.push(new Builder().id('8501db33-6aca-4e2a-bf98-494e4b3b2744').thema(thema).entry('gern(e)').example('Ich gehe gerne einkaufen.').get());
		entries.push(new Builder().id('dea36b68-1d19-42a3-aa23-fe453f2af9e3').thema(thema).entry('das Geschäft, -e').example('Die Geschäfte schließen um 18.30 Uhr.').get());
		...
		entries.push(new Builder().id('1fe233d8-289f-4b49-9855-f52f8546e228').thema(thema).entry('die Geschwister (pl.)').example('Ich habe leider keine Geschwister.').get());
		entries.push(new Builder().id('8b8a9041-7c6b-483c-a123-b5b3291a1661').thema(thema).entry('das Gespräch, -e').example('Das Gespräch mit Frau Kunz ist um 14 Uhr.').get());
		...
		entries.push(new Builder().id('9c6e700f-944c-45b9-b573-626876483228').thema(thema).entry('das Gewicht').example('Bei „Gewicht“ schreibst du: 62 Kilo.').get());
		entries.push(new Builder().id('2fd03d4c-dc3c-4ab5-8653-dd5223d2f2c6').thema(thema).entry('gewinnen').example('Wer gewinnt das Spiel?').get());
		...
		entries.push(new Builder().id('cbd8653e-5f28-4b18-869e-00c3d6559af1').thema(thema).entry('gleich').example(['Das ist mir gleich.', 'Das ist der gleiche Preis.', 'Ich komme gleich.']).get());
		...
		entries.push(new Builder().id('0e292060-e663-4fd3-bec3-e4c4171829cb').thema(thema).entry('das Glück').example('Viel Glück!').get());
		entries.push(new Builder().id('cac1961d-6885-432f-947a-0c8912dd0444').thema(thema).entry('glücklich').example('Meine Kinder sind glücklich verheiratet.').get());
		entries.push(new Builder().id('3b7d2425-2098-4308-ada4-adbd5e2c06ab').thema(thema).entry('der Glückwunsch').example('Herzlichen Glückwunsch zum Geburtstag.').get());
		...
		entries.push(new Builder().id('67333484-7cf2-4ad4-bdd9-64f9c02a4e7f').thema(thema).entry('gratulieren').example('Ich gratuliere dir!').get());
		...
		entries.push(new Builder().id('ba26d705-a05d-4c8f-a45e-ddfbbdec84c8').thema(thema).entry('groß').example(['Mein Bruder und ich sind gleich groß.', 'Frankfurt ist eine große Stadt.']).get());
		entries.push(new Builder().id('a7bffe25-5fb5-41d5-bf1f-e49db73a3982').thema(thema).entry('die Größe').example('Haben Sie das auch in Größe 40?').get());
		...
		entries.push(new Builder().id('25c9489f-0f40-4fd3-9d8c-4bffb447659c').thema(thema).entry('der Gruß, -ü, e').example(['Viele Grüße an Ihre Frau.', 'Mit freundlichen Grüßen']).get());
		...
		entries.push(new Builder().id('5301332c-5946-4f50-a03a-aec08ff92d06').thema(thema).entry('günstig').example('Dort gibt es günstige Angebote.').get());
    ...
    createHEntries(Builder) {
		...
		entries.push(new Builder().id('1257e658-5e96-413a-955f-660ac7baff12').thema(thema).entry('das Hähnchen, -').example('Ein Hähnchen mit Pommes bitte!').get());
		...
		entries.push(new Builder().id('58707e65-03b7-4fb5-a8b3-451d5a732e75').thema(thema).entry('halten').example('Dieser Zug hält nicht in Rüdesheim.').get());
		entries.push(new Builder().id('4b358e00-4aac-4c01-8260-57b6abdcdcf8').thema(thema).entry('die Haltestelle').example('An der nächsten Haltestelle müssen Sie aussteigen.').get());
		...
		entries.push(new Builder().id('01cf3a78-1822-4dac-93c9-04a8a71b2c14').thema(thema).entry('die Hausfrau, -en/der Hausmann').example('Die Hausfrau/der Hausmann wäscht, kocht und kauft ein.').get());
		entries.push(new Builder().id('c73e71b2-b665-4277-ad74-dfef3873672a').thema(thema).entry('die Heimat').example('Ich komme aus der Schweiz. Das ist meine Heimat.').get());
		...
		entries.push(new Builder().id('0ccb7209-1c16-4e39-93b4-613697cccf3c').thema(thema).entry('hell').example('Im Sommer ist es bis 21 Uhr hell.').get());
		entries.push(new Builder().id('9ac95f9c-b78f-43d3-a1b0-ef60858a6e04').thema(thema).entry('der Herd').example('In der neuen Küche fehlt noch der Herd.').get());
		...
		entries.push(new Builder().id('38d83747-4ba5-4b73-badc-0ab1b75c0562').thema(thema).entry('herzlich').example('Herzlichen Glückwunsch!').get());
		...
		entries.push(new Builder().id('ea5b6523-3ed4-4e14-a423-13d9d5944d86').thema(thema).entry('hinten').example('Die Tür zum Aussteigen ist hinten.').get());
		...
		entries.push(new Builder().id('e31ba7d3-903e-4473-a8fe-15fb3a24dea2').thema(thema).entry('hoch').example('Der Mount Everest ist 8.880 Meter hoch.').get());
		entries.push(new Builder().id('5aaff8c8-1428-4200-a8ed-6f4fad8c4def').thema(thema).entry('die Hochzeit').example('Zur dieser Hochzeit kommen mehr als fünfzig Gäste.').get());
		entries.push(new Builder().id('7d326178-68b5-4fcb-94ee-060025cd0e9a').thema(thema).entry('holen').example('Ich hole zwei Flaschen Wasser aus der Küche.').get());
		...
		entries.push(new Builder().id('19f2df1f-e936-446a-b469-b0597a1d0e47').thema(thema).entry('der Hunger').example('Ich habe Hunger! Wann ist das Essen fertig?').get());
        return entries;
    }
    ...
    createJEntries(Builder) {
		...
		entries.push(new Builder().id('2a81087c-03da-4dfc-9798-8e5650e6454f').thema(thema).entry('der Jugendliche, -n ').example('Viele Jugendliche kaufen gern ein.').get());
		entries.push(new Builder().id('bb394efd-86d7-4df9-ae2d-7eab8954726e').thema(thema).entry('jung').example('Claudia ist 21. – Was? Noch so jung?').get());
		entries.push(new Builder().id('239ee04a-9112-4e48-91c2-f517498763a1').thema(thema).entry('der Junge, -n ').example('Ich habe zwei Kinder. Einen Jungen und ein Mädchen.').get());
        return entries;
    }
    ...
    createKEntries(Builder) {
		...
		entries.push(new Builder().id('4361a7bd-4e63-47dd-9fe2-14322660ed18').thema(thema).entry('der Kaffee').example('Zum Frühstück trinke ich immer Kaffee.').get());
		...
		entries.push(new Builder().id('fc9b0c18-8c81-48a1-a605-da1614e66bf6').thema(thema).entry('kennen').example('Kennen Sie diese Frau? – Nein, leider nicht.').get());
		entries.push(new Builder().id('c6c9bd55-c1b6-4b87-85c0-cf6e75c2d43c').thema(thema).entry('kennenlernen').example('Wir sind neu hier. Wir möchten Sie kennenlernen.').get());
		...
		entries.push(new Builder().id('bd14d93c-21c6-452c-a325-5e6e0ebc884b').thema(thema).entry('klar').example('Kommst du mit? – Klar!').get());
		...
		entries.push(new Builder().id('3f4b9dac-1c52-4d98-9d20-ca1fc02c6b22').thema(thema).entry('der Koffer, –').example('Ist das Ihr Koffer?').get());
		...
		entries.push(new Builder().id('cbb14a81-cec4-425d-832b-849c98974b65').thema(thema).entry('können').example(['Ich kann Deutsch und Russisch.', 'Können Sie mir helfen?']).get());
		...
		entries.push(new Builder().id('4e5952b6-c8c9-4fbb-8752-43c153822209').thema(thema).entry('kriegen').example('Ich kriege 15 Euro in der Stunde für meine Arbeit.').get());
		...
		entries.push(new Builder().id('a08164b0-e21a-4089-9a8a-2a066bbd82a8').thema(thema).entry('der Kuchen').example('Ich nehme ein Stück Kuchen.').get());
		entries.push(new Builder().id('03f1331f-0e01-44e8-9373-69901ff10dec').thema(thema).entry('der Kugelschreiber').example('Hast du einen Kugelschreiber für mich?').get());
		entries.push(new Builder().id('0b604171-7482-4b8a-a7a8-61694ca9e6e6').thema(thema).entry('der Kühlschrank').example('Haben wir noch Milch? – Ja, im Kühlschrank.').get());
		entries.push(new Builder().id('88ef9933-47ca-486f-ac66-b8ee47ebb7a4').thema(thema).entry('kulturell').example('Ich bin kulturell interessiert. Ich gehe oft ins Museum.').get());
		entries.push(new Builder().id('d78bba6a-3944-4758-931f-cd80b0ed24e1').thema(thema).entry('sich kümmern').example('Jede Mutter kümmert sich um ihre kleinen Kinder.').get());
    ...
    createLEntries(Builder) {
		...
		entries.push(new Builder().id('6f2a489c-1fb5-40ca-8850-324e307c4604').thema(thema).entry('der Laden, -ä').example('Im Buchladen können Sie Bücher kaufen.').get());
		...
		entries.push(new Builder().id('7095ee28-8b10-452c-a475-fa03a54f3133').thema(thema).entry('lang').example('Die Jeans ist zu lang.').get());
		entries.push(new Builder().id('62d2bf47-5a0e-47eb-852e-d69606f668bb').thema(thema).entry('lange').example('Wie lange fährt der Zug von Hamburg nach Berlin?').get());
		...
		entries.push(new Builder().id('ce5db131-d1ac-43a5-badc-354cb562ac23').thema(thema).entry('laufen').example('Ich möchte nicht Auto fahren, ich möchte laufen.').get());
		entries.push(new Builder().id('987a8cd4-64fe-4df7-8de0-1fa533942e8d').thema(thema).entry('laut').example('Nicht so laut! Das Baby schläft.').get());
		...
		entries.push(new Builder().id('a36f5e15-faa5-4b31-af91-05e944f81a0f').thema(thema).entry('die Lebensmittel (pl.)').example('Lebensmittel bekommen Sie im Supermarkt.').get());
		...
		entries.push(new Builder().id('535f83a1-104e-40b1-9c23-0cd636f7cce2').thema(thema).entry('legen').example('Legen Sie das Buch auf den Tisch.').get());
		...
		entries.push(new Builder().id('66a4b671-b69a-4893-8e4c-82ea57987cbc').thema(thema).entry('leicht').example(['Der Koffer ist leicht.', 'Deutsch ist nicht leicht.']).get());
		...
		entries.push(new Builder().id('74f9bc4c-4a97-4ebc-94a8-cd001524c335').thema(thema).entry('leise').example('Seid leise. Die anderen schlafen schon.').get());
		...
		entries.push(new Builder().id('ba8bd0e7-31aa-4e35-895a-68999e13e64e').thema(thema).entry('lieben').example('Ich liebe dich!').get());
		entries.push(new Builder().id('b30680e8-ce0e-453c-ba00-d803f17f0d10').thema(thema).entry('lieber').example('Sie fährt lieber mit der Bahn.').get());
		entries.push(new Builder().id('db7697db-0492-4404-a222-0d2e034c1e77').thema(thema).entry('Lieblings-').example('Mein Lieblingsfilm ist „Schwarze Augen“.').get());
		entries.push(new Builder().id('afff57cb-a648-467d-96fe-2d0f5f082aa0').thema(thema).entry('das Lied, -er').example('Welches ist dein Lieblingslied?').get());
		entries.push(new Builder().id('07921aa4-47db-4a17-a97d-d668703d0550').thema(thema).entry('liegen').example(['Um neun Uhr liegt Judith noch im Bett.', 'Frankfurt liegt am Main.']).get());
		...
		entries.push(new Builder().id('e2f2da03-719b-46f2-9258-b0570d707220').thema(thema).entry('das Lokal').example('In unserer Straße gibt es ein neues Lokal.').get());
		...
		entries.push(new Builder().id('2d4e2e63-4910-401e-9de5-26327e01c27a').thema(thema).entry('lustig').example('Frau Mertens ist lustig. Sie lacht immer.').get());
        return entries;
    }
    ...
    createMEntries(Builder) {
		...
		entries.push(new Builder().id('7e066356-d7a2-49b7-8ce4-e34d6baa9346').thema(thema).entry('das Mädchen, –').example('Familie Kurz bekommt ein Baby. – Junge oder Mädchen?').get());
		...
		entries.push(new Builder().id('3960fdd8-8a5a-4066-ab25-e5486504f9ad').thema(thema).entry('männlich').example('Kreuzen Sie bitte an: „weiblich“ oder „männlich“.').get());
		...
		entries.push(new Builder().id('a7c9f552-06b5-470e-8a05-ecaec2ffb148').thema(thema).entry('meist-').example('Die meisten Norddeutschen sind sehr groß.').get());
		entries.push(new Builder().id('0bea5e9e-5c4b-4496-97b3-5a8502e139b6').thema(thema).entry('der Mensch, -en').example('Die Menschen sind hier anders als bei uns.').get());
		entries.push(new Builder().id('4948d16b-2b44-4354-b96c-8824cfc53ec9').thema(thema).entry('mieten').example('Ich möchte ein Auto mieten.').get());
    ...
    createSEntries(Builder) {
		...
		entries.push(new Builder().id('45289259-5f38-4d57-8249-4eec6b9b95c2').thema(thema).entry('der Schinken, –').example('Ich möchte gern ein Schinkenbrot.').get());
		...
		entries.push(new Builder().id('8b0132fb-8795-4b6e-a808-12c0655b3eab').thema(thema).entry('schlecht').example(['Mir ist schlecht!', 'Sie sehen schlecht aus.', 'Wir haben schlechtes Wetter.']).get());
		entries.push(new Builder().id('217db9f1-50d9-4986-b959-faafcf270716').thema(thema).entry('schließen').example('Bitte, schließen Sie die Tür.').get());
		...
		entries.push(new Builder().id('b5f2c82d-454b-4fbd-9886-fbcb47ebe1c5').thema(thema).entry('der Schluss').example(['Ich muss jetzt Schluss machen.', 'Zum Schluss gibt er uns allen die Hand.']).get());
		...
		entries.push(new Builder().id('78d74ad8-87c6-4f20-8125-504eb22f67f2').thema(thema).entry('schmecken').example('Schmeckt das gut?').get());
		entries.push(new Builder().id('5d5f640c-ebfe-4bf4-92ec-61db30704cfd').thema(thema).entry('schnell').example('Er fährt schnell.').get());
		entries.push(new Builder().id('ac295196-3965-4b7b-9fc9-dd1c111bab03').thema(thema).entry('schon').example('Ist das Essen schon fertig?').get());
		entries.push(new Builder().id('5d9a92bf-cc26-4f71-bbc9-68e8db69842f').thema(thema).entry('schön').example(['Schönen Urlaub!', 'Das ist sehr schön.']).get());
		entries.push(new Builder().id('827b8aa5-53c5-409c-a537-f7a7de271f67').thema(thema).entry('der Schrank, -ä, e').example('Die Gläser stehen im Schrank.').get());
		...
		entries.push(new Builder().id('90a4a0cd-fe3c-4268-9a58-a0087ff29ec5').thema(thema).entry('der Schüler, –').example('In meinem Kurs sind acht Schülerinnen und fünf Schüler.').get());
		entries.push(new Builder().id('05b35834-8edf-4707-b5c4-582c893da7c8').thema(thema).entry('schwer').example(['Ist Ihr Gepäck sehr schwer?', 'Das ist eine schwere Arbeit.']).get());
		...
		entries.push(new Builder().id('b26737c0-72ff-494e-9ecd-a22ebe1f4a80').thema(thema).entry('das Schwimmbad').example('Kommst du mit ins Schwimmbad?').get());
		entries.push(new Builder().id('6aae2aa6-7d53-4596-a4fc-a8839585638e').thema(thema).entry('der See').example('Komm, wir fahren zum Starnberger See.').get());
		...
		entries.push(new Builder().id('69c45555-97e4-4bc8-b744-904e9e6c05a4').thema(thema).entry('die Sehenswürdigkeit, -en').example('Welche Sehenswürdigkeiten gibt es in Frankfurt?').get());
		entries.push(new Builder().id('e32be5d1-6bd9-4010-8aeb-bc4b75bb1cb4').thema(thema).entry('sehr').example(['Danke sehr!', 'Das ist sehr schwer.']).get());
		...
		entries.push(new Builder().id('0dc05a74-2c27-4a62-a4b3-9c1101a93d81').thema(thema).entry('an sein').example('Das Licht ist noch an.').get());
		entries.push(new Builder().id('1ed3eff7-1bf5-4a89-a4b7-bfa4666c6f73').thema(thema).entry('auf sein').example('Das Fenster ist noch auf.').get());
		entries.push(new Builder().id('9e036177-2e38-4b50-a813-7575381419a5').thema(thema).entry('weg sein').example('Herr Meier ist schon weg.').get());
		entries.push(new Builder().id('f90bc5a5-aa80-4ff7-b0e6-2caeec186796').thema(thema).entry('zu sein').example('Die Tür ist zu.').get());
		entries.push(new Builder().id('4a698023-f846-4f37-b41b-4423c9a91dc4').thema(thema).entry('seit').example('Ich wohne seit drei Jahren in Köln.').get());
		entries.push(new Builder().id('ad3b4bd3-0ae4-4172-aa0e-e2f41f700745').thema(thema).entry('selbstständig').example('Er ist selbstständig.').get());
		entries.push(new Builder().id('2cf6b5e4-7d56-4e4b-a26e-9153a850e9bb').thema(thema).entry('sich').example('Sie müssen sich erst anmelden.').get());
		...
		entries.push(new Builder().id('a2c74059-f02f-4a7b-9736-8d2d6dfbc2bc').thema(thema).entry('sitzen').example('Wo sitzen Sie?').get());
		entries.push(new Builder().id('fe4da5c6-42bb-46e5-8442-383b7acfb1bd').thema(thema).entry('so').example(['Sie müssen das so machen!', 'Fahren Sie bitte nicht so schnell!', 'Meine Frau ist so groß wie ich.', 'So, das war‘s/wär‘s!']).get());
		entries.push(new Builder().id('d1e45c65-8242-4a86-b994-53ad27fe116a').thema(thema).entry('das Sofa').example('Das Sofa ist neu.').get());
		entries.push(new Builder().id('bf3df91b-4509-4364-a0f6-f7a5d5b2efd6').thema(thema).entry('sofort').example('Bitte antworten Sie sofort.').get());
		...
		entries.push(new Builder().id('8f904fb3-1f92-4177-bfaa-ade8170c8f51').thema(thema).entry('sollen').example(['Soll ich kommen?', 'Was soll ich mitbringen?']).get());
		...
		entries.push(new Builder().id('8cd12ade-51e8-4c79-ab5c-628b54cdbe85').thema(thema).entry('spät').example('Es ist schon spät, ich muss gehen.').get());
		entries.push(new Builder().id('9b310c9e-6ae5-4ca5-b224-db89e5657f53').thema(thema).entry('später').example('Das können wir später machen.').get());
		entries.push(new Builder().id('6f295410-24ea-4ed3-ae40-bae68290cb16').thema(thema).entry('die Speisekarte').example('Bringen Sie mir die Speisekarte, bitte.').get());
		...
		entries.push(new Builder().id('0e5becb0-f7f3-47b8-85b6-d1ba33a69d8d').thema(thema).entry('sprechen').example('Kann ich (mit) Herrn Klein sprechen?').get());
		...
		entries.push(new Builder().id('420b77cd-e725-425f-9475-f611ff5d56f5').thema(thema).entry('stehen').example(['Ich glaube es nicht, aber es steht in der Zeitung.', 'Der Bus steht schon an der Haltestelle.']).get());
		entries.push(new Builder().id('41d5feb8-250d-43a4-8b1e-7b1663fbc3af').thema(thema).entry('die Stelle, -n').example('Ich habe eine neue Stelle.').get());
		entries.push(new Builder().id('e31eba4c-b71e-46c9-81b8-1138db1ca957').thema(thema).entry('stellen').example('Stell die Tasche rechts in die Ecke!').get());
		entries.push(new Builder().id('5a9bd98b-da5d-423f-8554-d5b4fb13f460').thema(thema).entry('der Stock').example('Unsere Wohnung liegt im ersten Stock.').get());
		...
		entries.push(new Builder().id('5f654db8-ff80-4812-bb45-5d5d2729d839').thema(thema).entry('die Straßenbahn').example('Wo fährt die Straßenbahn ab?').get());
		entries.push(new Builder().id('38bbd9d5-47bb-4cb1-9299-6e7fae53e3d0').thema(thema).entry('studieren').example('Ich studiere in Mainz.').get());
		entries.push(new Builder().id('c51e6593-17b4-4ce1-a563-46e6358afe73').thema(thema).entry('das Studium').example('Das Studium beginnt im Oktober.').get());
		entries.push(new Builder().id('97e6f788-61cc-4583-aee7-bcbea7d2af6c').thema(thema).entry('der Student, -en').example('Ich bin Studentin.').get());
    ...
    createTEntries(Builder) {
		...
		entries.push(new Builder().id('1ee7e990-a27d-43d8-b358-f3ce6056ee7e').thema(thema).entry('der Teil, -e').example('Lies bitte auch den zweiten Teil.').get());
		...
		entries.push(new Builder().id('17fd34fd-fa6f-42ee-a6ac-5016193bfbd7').thema(thema).entry('der Termin, -e').example('Am besten machen wir sofort einen Termin.').get());
		...
		entries.push(new Builder().id('d1578a11-98ad-45d7-b40c-bdaf6d1092fa').thema(thema).entry('tot').example('Sein Vater ist schon lange tot.').get());
		entries.push(new Builder().id('e19ca9ec-ddf8-4f7d-9deb-b7656c1a96fa').thema(thema).entry('(sich) treffen').example(['Ich treffe in der Stadt einen Kollegen.', 'Wir treffen uns immer freitags.']).get());
		entries.push(new Builder().id('e831c2ee-9f1d-4491-b2d5-9b5501c9b299').thema(thema).entry('die Treppe, -n').example('Die Toilette? Die Treppe hoch und dann links.').get());
		...
		entries.push(new Builder().id('4f66524f-00b6-476b-95eb-0b3c96547185').thema(thema).entry('tschüss').example('Junge Leute sagen meistens „tschüss!“ und nicht „auf Wiedersehen“.').get());
		entries.push(new Builder().id('04d5b1f3-6b2b-4776-8e4d-e65ada518eef').thema(thema).entry('tun').example(['Ich habe noch etwas zu tun.', 'Was tut Ihr Mann?']).get());
        return entries;
    }
    ...
    createUEntries(Builder) {
		...
		entries.push(new Builder().id('39db38b2-a6d5-4596-ac42-8b223ed818be').thema(thema).entry('über').example(['Gehen Sie hier über die Straße.', 'Er wohnt im zweiten Stock über Familie Meier.', 'Sind Sie über 18?']).get());
		entries.push(new Builder().id('ef2c525f-225a-4b9a-9ea6-ee3b2c7b0210').thema(thema).entry('übernachten').example('Du kannst bei mir übernachten.').get());
		entries.push(new Builder().id('c1f7de82-4c98-4d5a-a0ce-2aeb40381a4a').thema(thema).entry('überweisen').example('Sie können das Geld auch überweisen.').get());
		entries.push(new Builder().id('944bc68e-1082-46ca-90d5-c34c4ff2f403').thema(thema).entry('die Uhr').example('Es ist vier Uhr.').get());
		entries.push(new Builder().id('f61dd0c6-3acf-4c96-92bc-492e24166de4').thema(thema).entry('um').example(['Er kommt um sieben Uhr.', 'Da kommt er gerade um die Ecke.']).get());
		entries.push(new Builder().id('3f2024a8-df57-4c14-a72b-cb830561f518').thema(thema).entry('umziehen').example('Nächsten Monat ziehen wir um.').get());
		...
		entries.push(new Builder().id('7396cd3b-4187-4b22-86e7-dbb30e4c845e').thema(thema).entry('unten').example('Er wohnt ganz unten im Haus.').get());
		entries.push(new Builder().id('4608c0d5-1b0f-4743-92a8-e321658db95c').thema(thema).entry('unter').example('Unter uns wohnt eine Familie mit drei Kindern.').get());
		entries.push(new Builder().id('c4e16d15-ea99-4005-acd0-111e8d20dc80').thema(thema).entry('der Unterricht').example('Wir haben Unterricht von 8.00 bis 12.00 Uhr.').get());
		entries.push(new Builder().id('bc425496-2c17-4d3b-9ec7-0dc70e0522a3').thema(thema).entry('unterschreiben').example('Wo muss ich unterschreiben?').get());
		entries.push(new Builder().id('c8344ada-ec7f-40a4-ac79-3483af24c2fa').thema(thema).entry('die Unterschrift').example('Hier fehlt noch Ihre Unterschrift.').get());
    ...
    createVEntries(Builder) {
		...
		entries.push(new Builder().id('55d3fca3-0ba1-4a8d-9932-95cad67a07d8').thema(thema).entry('der Verein').example('Es gibt einen neuen Sportverein in der Stadt.').get());
		entries.push(new Builder().id('d573acc9-413c-4e69-845f-e55abfbe4244').thema(thema).entry('verheiratet').example('Ich bin verheiratet und habe drei Kinder.').get());
		entries.push(new Builder().id('63e83c34-5058-4a2e-b87e-f97635be90b8').thema(thema).entry('verkaufen').example('Er verkauft sein altes Auto.').get());
		entries.push(new Builder().id('7e644785-b504-40a3-8d94-f90635e59a82').thema(thema).entry('der Verkäufer, –').example('Meine Mutter ist Verkäuferin im Kaufhaus.').get());
		entries.push(new Builder().id('db3fba27-cc73-4ba8-b709-5954ee65d637').thema(thema).entry('vermieten').example('Die Wohnung ist schon vermietet.').get());
		entries.push(new Builder().id('ede4cb5f-6193-459f-86ed-d57f85ea00d9').thema(thema).entry('der Vermieter').example('Unser Vermieter heißt Huber. Er wohnt auch hier.').get());
		...
		entries.push(new Builder().id('c08f686d-afa1-4f80-a589-91cda2c4250c').thema(thema).entry('der Verwandte, -n').example('Peter besucht seine Verwandten in Polen.').get());
		...
		entries.push(new Builder().id('ca9108fd-d181-4fdd-92a8-d373994fb4fe').thema(thema).entry('vor').example(['Der Termin war vor einer Stunde.', 'Das Auto steht vor der Tür.']).get());
		...
		entries.push(new Builder().id('d9392ca4-684f-4e60-8d72-9352836caea8').thema(thema).entry('die Vorsicht').example('Vorsicht! Da kommt ein Auto.').get());
		entries.push(new Builder().id('23ceccff-16dc-4f05-af58-7832bbd991bf').thema(thema).entry('(sich) vorstellen').example('Wir wollen uns kennenlernen. Können Sie sich bitte vorstellen?').get());
		entries.push(new Builder().id('a171a0e3-11bc-4139-a70c-008253372029').thema(thema).entry('die Vorwahl').example('Wie ist die Vorwahl von München?').get());
        return entries;
    }
    ...
    createWEntries(Builder) {
		...
		entries.push(new Builder().id('c3956c93-e26f-4356-a99d-543fa384aec5').thema(thema).entry('wandern').example('Wir wandern um den Chiemsee.').get());
		...
		entries.push(new Builder().id('06fe2128-0be2-46f6-b4ae-c8b3ec1e4318').thema(thema).entry('was für ein').example('Was für eine Farbe möchten Sie?').get());
		entries.push(new Builder().id('e2353e8b-c925-4c9b-b71d-c35d8c5dce17').thema(thema).entry('(sich) waschen').example(['Wo kann ich mir die Hände waschen?', 'Ich muss morgen waschen.']).get());
		...
		entries.push(new Builder().id('2bd8dce5-c48f-405f-baaf-c7fad6c67392').thema(thema).entry('weh tun').example('Ich muss zum Arzt. Mein Bein tut weh.').get());
		entries.push(new Builder().id('10d7f529-b807-4bba-bddd-6927de1c37fe').thema(thema).entry('weiblich').example('Kreuzen Sie bitte an: „weiblich“ oder „männlich“.').get());
		...
		entries.push(new Builder().id('e5793aad-8d95-426e-a4a3-b0ea3b8b3244').thema(thema).entry('weit').example('Zum Bahnhof ist es nicht weit.').get());
		entries.push(new Builder().id('044a40a8-bdb5-4a2d-9d26-359367cd5f1a').thema(thema).entry('weiter').example('Der Bus fährt nicht weiter.').get());
		entries.push(new Builder().id('81a834ce-fe5d-4c01-a92c-46ba689dacdc').thema(thema).entry('welch-').example('Welches Buch möchtest du?').get());
		entries.push(new Builder().id('b4920d58-7526-406b-ab3e-b061674e5c2c').thema(thema).entry('die Welt').example('Es gibt viele Probleme auf der Welt.').get());
		entries.push(new Builder().id('fd1b3306-3fc2-4d69-b3cf-5eed0287d337').thema(thema).entry('wenig').example(['Ich habe leider nur wenig verstanden.', 'Er verdient wenig.']).get());
		entries.push(new Builder().id('48c985a2-4ef0-42c3-9cad-f37b2a41e0ec').thema(thema).entry('wer').example('Wer ist das?').get());
		entries.push(new Builder().id('b6fa2e71-17fa-45ca-9e37-821ae66dff20').thema(thema).entry('werden').example('Mein Sohn will Arzt werden.').get());
