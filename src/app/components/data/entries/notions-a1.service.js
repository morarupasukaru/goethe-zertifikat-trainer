class NotionsA1Service {
    ...
    createNotionsWordEntries(Builder) {
        ...
        entries.push(new Builder().id('3bd7bd82-1e2d-4551-8571-dd39cc577a0d').thema(thema).entry('Vorzeitigkeit').get());
        entries.push(new Builder().id('6efca814-8b1a-4b76-901b-28112e877aad').thema(thema).entry('Nachzeitigkeit').get());
        entries.push(new Builder().id('a5f1bf45-dd10-4ef6-b5fd-df4cafab1d9d').thema(thema).entry('Zukunftsbezug').get());
        entries.push(new Builder().id('f3302f3c-ac26-4e15-9176-d6aae3237d90').thema(thema).entry('Gegenwartsbezug').get());
        entries.push(new Builder().id('191a5c63-e9cb-45b9-99d7-3ccf7865b366').thema(thema).entry('Vergangenheitsbezug').get());
        entries.push(new Builder().id('6ab8a26b-2532-45be-bae7-0f5f06b8fdb5').thema(thema).entry('Verspätung').get());
        entries.push(new Builder().id('8bed217f-f32d-440c-bdc0-fbd67a7f32e1').thema(thema).entry('Frühzeitigkeit').get());
        entries.push(new Builder().id('7d9462dd-b5b0-4e39-b06c-24042827fd3a').thema(thema).entry('Beginn').get());
